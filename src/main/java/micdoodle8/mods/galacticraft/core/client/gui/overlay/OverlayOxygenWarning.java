...
public class OverlayOxygenWarning extends Overlay
{
    ...
    public static void renderOxygenWarningOverlay()
    {
        ...
        OverlayOxygenWarning.minecraft.fontRenderer.drawString(GCCoreUtil.translate("gui.oxygen.warning"), width / 4 - OverlayOxygenWarning.minecraft.fontRenderer.getStringWidth(GCCoreUtil.translate("gui.oxygen.warning")) / 2, height / 8 - 15, ColorUtil.to32BitColor(alpha, 255, 0, 0));
